...
<body onclick = "mouseClick();">
    <section class="container mapinfo d-flex flex-column col-12" style = "height:auto; min-height:100vh;">
        @if (Route::has('login'))
            @auth
        ...
        @endif
        <div class="row">
            <div class=" bg-black col-md-5 mt-4" style="border-radius: 0px 50px 50px 0px;" >
                @if($tenants[0] -> floor === 1)
                    <h1 style="font-size:70px" class="title"> 1st Floor <img class = "ml-3"src="/img/level.png" alt=""></h1>
                @else
                    <h1 style="font-size:70px" class="title"> 2nd Floor <img class = "ml-3"src="/img/level.png" alt=""></h1>
                @endif
            </div>
            <div class = "col-md-5">
            </div>
            <div class ="col-md-2 m-auto p-auto">
                 <a  href="{{ route('frontend.navigation')}}" class="btn btn-primary">
                     <img class = "m-auto" src="/img/back.png" alt="" > Back
                </a>
            </div> 
        </div>

        <div class ="mapNav row">
            <div class="floorNav col-md-4 my-auto">
                <table>
                        <tr><h1 class="mt-2 text-center" style ="font-size:90px ">Levels</h1></tr>
                        <tr>
                            <hr style=" border: 6px solid grey; border-radius: 3px;">
                            <tr>
                        <tr>
                            <a style="color:black;" href="{{route('frontend.mapView', 1)}}">
                        ...
                        <tr>
                            <a style="color:black;" href="{{route('frontend.mapView', 2)}}">
                                <h1 class = "text-center mt-3" style = "{{
                                ($tenants[0] -> floor === 2)?
                                    'background: lightblue; border-radius: 10px;': ''
                            }}">2nd Floor</h1>
            ...
            <div class= "col-md-8">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                      width="auto" height="auto" viewBox="0 0 1000 600" enable-background="new 0 0 500 300" xml:space="preserve">
                    ...
                    <g id="landmarks-level1">
                        ...
                        @if(count($tenants) >= 1)
                        <a xlink:title="{{$tenants[0] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[0] -> floor, $tenants[0] -> id]) }}">
                            <polygon fill="#DF8D5E" points="590,167.4 601.2,184.2 575.5,189.4 564.5,172.4 	"/> 
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="749.5,204.2 756.7,213.6 746.8,215.8 739.6,206.3 	"/>
                        @if(count($tenants) >= 2)
                        <a xlink:title="{{$tenants[1] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[1] -> floor, $tenants[1] -> id]) }}">
                            <polygon fill="#DF8D5E" points="749.5,204.2 756.7,213.6 746.8,215.8 739.6,206.3 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 3)
                        <a xlink:title="{{$tenants[2] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[2] -> floor, $tenants[2] -> id]) }}">
                            <polygon id="applebees" fill="#D84632" points="777.1,134.6 830.5,199.1 821.5,221.5 796.2,214.1 764.4,221.2 737.6,186.3 
                                671.1,200.3 651.1,172.1 716.2,159 723.3,145.3 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 4)
                        <a xlink:title="{{$tenants[3] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[3] -> floor, $tenants[3] -> id]) }}">
                            <polygon fill="#DF8D5E" points="601.9,185.3 609.6,196.7 583.7,202.1 576.2,190.5 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 5)
                        <a xlink:title="{{$tenants[4] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[4] -> floor, $tenants[4] -> id]) }}">
                            <polygon id="cvs" fill="#DF8D5E" points="526.2,148.4 541.7,153.4 549.5,165.6 562.3,185.6 522.1,193.7 509.8,173.3 447.1,185.5 
                                440.9,174.3 436,165.5 436.8,165.3 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 6)
                        <a xlink:title="{{$tenants[5] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[5] -> floor, $tenants[5] -> id]) }}">
                            <polygon id="pizzahut" fill="#DF8D5E" points="621.5,171.8 647.1,179.5 658.5,195.7 651,197.3 655.4,203.6 610.9,213 602,199.6 
                                612.3,197.5 598.2,176.5 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 7)
                        <a xlink:title="{{$tenants[6] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[6] -> floor, $tenants[6] -> id]) }}">
                            <polygon fill="#DF8D5E" points="738,206.7 746,217.3 757.6,214.8 762.8,221.6 716.8,231.8 708.4,213.1 	"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="561.6,199.4 566.8,207.6 550.6,210.9 545.5,202.7 	"/>
                        @if(count($tenants) >= 8)
                        <a xlink:title="{{$tenants[7] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[7] -> floor, $tenants[7] -> id]) }}">
                            <polygon fill="#DF8D5E" points="561.6,199.4 566.8,207.6 550.6,210.9 545.5,202.7 	"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="522.9,201.3 508.7,221.6 499.6,206.1 	"/>
                        @if(count($tenants) >= 9)
                        <a xlink:title="{{$tenants[8] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[8] -> floor, $tenants[8] -> id]) }}">
                            <polygon fill="#DF8D5E" points="522.9,201.3 508.7,221.6 499.6,206.1 	"/>
                        </a>
                        @endif
                        <polygon id="mcdonalds" fill="#DF8D5E" points="751.2,225.6 764.8,243.6 719.7,253.9 717.2,233.1 	"/>
                        @if(count($tenants) >= 10)
                        <a xlink:title="{{$tenants[9] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[9] -> floor, $tenants[9] -> id]) }}">
                            <polygon id="mcdonalds" fill="#DF8D5E" points="751.2,225.6 764.8,243.6 719.7,253.9 717.2,233.1 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 11)
                        <a xlink:title="{{$tenants[10] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[10] -> floor, $tenants[10] -> id]) }}">
                            <polygon id="pullnbear" fill="#DF8D5E" points="508.8,174.9 523.9,199.8 497.1,205.3 507.6,223.2 472.2,230.6 461.7,211.8 
                                471.4,209.8 465.1,198.6 455.4,200.5 447.8,186.8 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 12)
                        <a xlink:title="{{$tenants[11] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[11] -> floor, $tenants[11] -> id]) }}">
                            <polygon fill="#DF8D5E" points="612.9,243.1 623.7,259.6 599.1,265.1 596.5,261 605.9,244.6"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="444.9,202.6 461.4,232.8 414.9,242.5 399.2,211.7"/>
                        @if(count($tenants) >= 13)
                        <a xlink:title="{{$tenants[12] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[12] -> floor, $tenants[12] -> id]) }}">
                            <polygon fill="#DF8D5E" points="444.9,202.6 461.4,232.8 414.9,242.5 399.2,211.7"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="614.3,290 622.7,303.3 605.7,307.4 597.4,294"/>
                        @if(count($tenants) >= 14)
                        <a xlink:title="{{$tenants[13] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[13] -> floor, $tenants[13] -> id]) }}">
                            <polygon fill="#DF8D5E" points="614.3,290 622.7,303.3 605.7,307.4 597.4,294 	"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="335.7,238 350.5,270.2 330.1,274.5 315.8,242 	"/>
                        @if(count($tenants) >= 15)
                        <a xlink:title="{{$tenants[14] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[14] -> floor, $tenants[14] -> id]) }}">
                            <polygon fill="#DF8D5E" points="335.7,238 350.5,270.2 330.1,274.5 315.8,242 	"/>
                        </a>
                        @endif
                        <polygon id="subway" fill="#DF8D5E" points="698.7,299.7 722.2,310.8 733.7,307.9 746.1,325.5 702.1,336.6 685,311 	"/>
                        @if(count($tenants) >= 16)
                        <a xlink:title="{{$tenants[15] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[15] -> floor, $tenants[15] -> id]) }}">
                            <polygon id="subway" fill="#DF8D5E" points="698.7,299.7 722.2,310.8 733.7,307.9 746.1,325.5 702.1,336.6 685,311 	"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="313.9,242.4 325.3,268.3 291,275.5 293.8,282.2 272.8,286.6 259.6,253.4 	"/>
                        @if(count($tenants) >= 17)
                        <a xlink:title="{{$tenants[16] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[16] -> floor, $tenants[16] -> id]) }}">
                            <polygon fill="#DF8D5E" points="313.9,242.4 325.3,268.3 291,275.5 293.8,282.2 272.8,286.6 259.6,253.4 	"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="313.9,242.4 325.3,268.3 291,275.5 293.8,282.2 272.8,286.6 259.6,253.4 	"/>
                        @if(count($tenants) >= 18)
                        <a xlink:title="{{$tenants[17] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[17] -> floor, $tenants[17] -> id]) }}">
                            <polygon fill="#DF8D5E" points="313.9,242.4 325.3,268.3 291,275.5 293.8,282.2 272.8,286.6 259.6,253.4 	"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="539.5,280.9 567.3,290.7 595.4,337.6 548.5,349 547.5,349.3 539.9,335.7 539.5,335 512.8,325.4 
                                494,291.2 	"/>
                        @if(count($tenants) >= 19)
                        <a xlink:title="{{$tenants[18] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[18] -> floor, $tenants[18] -> id]) }}">
                            <polygon fill="#DF8D5E" points="539.5,280.9 567.3,290.7 595.4,337.6 548.5,349 547.5,349.3 539.9,335.7 539.5,335 512.8,325.4 
                                494,291.2 	"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="492.2,291.6 510.9,325.8 493.2,330 487.3,339.4 437.5,351.2 426.3,328.4 447.7,323.4 437.8,303.8 	
                                "/>
                        @if(count($tenants) >= 20)
                        <a xlink:title="{{$tenants[19] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[19] -> floor, $tenants[19] -> id]) }}">
                            <polygon fill="#DF8D5E" points="492.2,291.6 510.9,325.8 493.2,330 487.3,339.4 437.5,351.2 426.3,328.4 447.7,323.4 437.8,303.8 	
                                "/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 21)
                        <a xlink:title="{{$tenants[20] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[20] -> floor, $tenants[20] -> id]) }}">
                            <polygon fill="#DF8D5E" points="261,276 276.2,314.5 183.9,334.7 170.8,294.8 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 22)
                        <a xlink:title="{{$tenants[21] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[21] -> floor, $tenants[21] -> id]) }}">
                            <polygon id="atnt" fill="#DF8D5E" points="408,295.3 435.9,304.3 445,322.5 423.6,327.4 435.5,351.7 375.1,366.1 374.1,366.3 
                                371.5,360.3 370.8,358.8 329.6,368.5 308.4,317.4 	"/>
                        </a>
                        @endif
                        <polygon fill="#DF8D5E" points="439.8,175.8 453,199.7 385.9,213 377.8,196.9 418.9,188.9 418.2,187.8 414.4,180.6 415.3,180.5 	
                                "/>
                        @if(count($tenants) >= 23)
                        <a xlink:title="{{$tenants[22] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[22] -> floor, $tenants[22] -> id]) }}">
                            <polygon fill="#DF8D5E" points="439.8,175.8 453,199.7 385.9,213 377.8,196.9 418.9,188.9 418.2,187.8 414.4,180.6 415.3,180.5 	
                                "/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 24)
                        <a xlink:title="{{$tenants[23] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[23] -> floor, $tenants[23] -> id]) }}">
                            <polygon fill="#DF8D5E" points="765.7,244.8 775,257 716.8,270.6 719.7,255.3 	"/>
                        </a>
                        @endif
                        <polygon id="kfc" fill="#DF8D5E" points="708.4,287.9 724.2,294.5 766.3,284.4 788.5,314.6 747.7,324.9 734.5,306.1 722.5,309.1 
                                699.8,298.5 	"/>
                        @if(count($tenants) >= 25)
                        <a xlink:title="{{$tenants[24] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[24] -> floor, $tenants[24] -> id]) }}">
                            <polygon id="kfc" fill="#DF8D5E" points="708.4,287.9 724.2,294.5 766.3,284.4 788.5,314.6 747.7,324.9 734.5,306.1 722.5,309.1 
                                699.8,298.5 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 26)
                        <a xlink:title="{{$tenants[25] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[25] -> floor, $tenants[25] -> id]) }}">
                            <polygon fill="#DF8D5E" points="596.2,339 618,357.5 561.3,371.7 560.3,372 548.4,350.7 549.3,350.5 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 27)
                        <a xlink:title="{{$tenants[26] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[26] -> floor, $tenants[26] -> id]) }}">
                            <polygon id="amc" fill="#D84632" points="727.3,331.6 782.4,411.7 774.6,432.4 619.1,476.6 591,466 589.6,465.4 541.8,378.3 
                                542.8,378.1 623.1,357.9 632,372.5 670.1,362.7 660.9,348.3 	"/>
                        </a>
                        @endif
                        ...
                        @if(count($tenants) >= 28)
                        <a xlink:title="{{$tenants[27] -> shopName}}" xlink:href = "{{ route('frontend.mapView.detail', [$tenants[27] -> floor, $tenants[27] -> id]) }}">
                            <polygon fill="#D84632" points="168.7,295.2 182.3,336.5 266.5,318 269.6,326 306.4,317.8 327.5,369 305.5,374.2 314.8,397.4 
                                133.9,441.2 106.3,430 104.9,429.4 75,314.7 76.1,314.5 	"/>
                        </a>
                        @endif
